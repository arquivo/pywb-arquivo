Content = {
    ...
    recordHref:"/services/archivepagenow?l=en",
    newSearch:"New search",
    recordPages:"ArchivePageNow",
    ...
    notArchived:"Page not found.",
    weSuggest:"We suggest that you:",
    firstSuggestion:"Use <a id='archiveNow'>ArchivePageNow</a> to record the missing page",
    secondSuggestion:"<a id='suggestToArquivo'>Suggest</a> the page to be archived",
    thirdSuggestion:"Search <a id='otherArchives'> other web archives</a>",
    shortSuggestion:"Please verify that the web address is correct.",
    archivePageNowURL:"https://arquivo.pt/archivepagenow",
    suggestURL:"https://arquivo.pt/suggest",
    ...
    completePageUsingPatchingConfirmationMessage: "We will try to complete the page with resources from other web archives",
    ...
    leavingArquivoToReplayWithOldBrowsers: "You are leaving Arquivo.pt to <a id=\"OldWebTodayOutlink\" href=\"http://oldweb.today/\" target=\"_blank\">oldweb.today</a>",
